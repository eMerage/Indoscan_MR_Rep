 ...
 */
public class ProductExpAdapter extends RecyclerView.Adapter<ProductExpAdapter.MyViewHolder> {

    Context mContext;
    ArrayList<Products> productItems;

    ProductsUnavailabilityPresenter productsUnavailabilityPresenter;
    public ProductExpAdapter(Context mContext, ArrayList<Products> item, ProductsUnavailabilityView view) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.relativeLayoutMain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                productsUnavailabilityPresenter.getSelectedExpProductID(products);
