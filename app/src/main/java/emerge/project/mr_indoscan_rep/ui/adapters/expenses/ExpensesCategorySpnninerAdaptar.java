...
public class ExpensesCategorySpnninerAdaptar extends ArrayAdapter<String> {


    private final LayoutInflater mInflater;
    private final Context mContext;
    private final ArrayList<ExpencesCategorys> items;
    private final int mResource;

    public ExpensesCategorySpnninerAdaptar(@NonNull Context context, @LayoutRes int resource,
    ...
    private View createItemView(int position, View convertView, ViewGroup parent){
        ...
        ExpencesCategorys offerData = items.get(position);
